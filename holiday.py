...
class SouthAfricanHolidays(AbstractHolidayCalendar):
    """
    South African Gov Holiday Calendar 
    """
    rules = [
        Holiday('New Years Day', month=1, day=15, observance=sunday_to_monday),
        Holiday('Human Rights Dayy', month=3, day=21, observance=sunday_to_monday),
